...
4. Create and push an exact tag such as `esx-eval-runner-v0.4.0`.
...
provenance feature. Do not describe a release as provenance-verified unless the
attestation step completed successfully.
