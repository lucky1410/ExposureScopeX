...
def _coverage_section(report: dict[str, Any]) -> str:
    ...
    for module in report["modules"]:
        ...
        dependencies = ", ".join("<a href='#module-" + _e(d) + "'>" + _e(d) + "</a>" for d in module.get("depends_on", [])) or "None declared"
...
section{margin-bottom:36px}td{overflow-wrap:anywhere}.table-wrap{border:1px solid var(--border)}nav{flex-wrap:wrap}
</style></head><body><main><nav><a href='#actions'>What needs attention</a><a href='#changes'>What changed</a><a href='#coverage'>Coverage</a><a href='#modules'>Module results</a><a href='#basis'>Evaluation basis</a></nav>""" + (
        ...
        + "</p></header><div class='stats'>" + stats + "</div><section id='actions'><h2>What needs attention</h2>"
