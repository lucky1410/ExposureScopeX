    ...
    <main className="workspacePage">
      ...
      {runMethod === "local" && <section className="registrySection clientRunnerGuide" id="client-delivery">
        ...
        <div className="clientRunnerSteps">
          ...
          <div><span>02 / CREATE AND RUN LOCALLY</span><strong>Get terminal results without uploading</strong><code>esx-eval init --directory .\my-agent-evaluation --agent-id support-agent --subject-version 2.4.0 --case-count 8</code><code>esx-eval run --config .\esx-eval.json --out .\out\evaluation.json</code><small>Creates eight labelled placeholders, a guide, and <code>local_adapter.py</code>. Connect its single <code>evaluate_case()</code> function and replace the placeholders. Results print in the local terminal and stay in the local output file. No key, identity, upload, or 20-case platform gate is required.</small></div>
