    ...
    <main className="workspacePage">
      ...
      {runMethod === "local" && <section className="registrySection clientRunnerGuide" id="client-delivery">
        ...
        <div className="clientRunnerSteps">
          <div><span>01 / INSTALL VERIFIED RELEASE</span><strong>Download only the runner</strong><a href="https://github.com/lucky1410/ExposureScopeX/releases" target="_blank" rel="noreferrer">OPEN GITHUB RELEASES</a><code>py -m pip install .\exposurescopex_eval_runner-&lt;version&gt;-py3-none-any.whl</code><small>Download the versioned wheel and <code>SHA256SUMS</code>, verify the checksum, then install. Do not download source code or the whole ExposureScopeX platform. <a href="https://github.com/lucky1410/ExposureScopeX/blob/main/v3/client-runner/README.md#local-only-quick-start" target="_blank" rel="noreferrer">OPEN THE STEP-BY-STEP GUIDE</a></small></div>
          <div><span>02 / CREATE AND RUN LOCALLY</span><strong>Get terminal results without uploading</strong><code>esx-eval init --directory .\my-agent-evaluation --agent-id support-agent --subject-version 2.4.0</code><code>esx-eval run --config .\esx-eval.json --out .\out\evaluation.json</code><small>Creates one labelled smoke-test placeholder, a guide, and <code>local_adapter.py</code>. Connect its single <code>evaluate_case()</code> function and replace the placeholder. Results print in the local terminal and stay in the local output file. Use more cases when measuring real quality. No key, identity, upload, or 20-case platform gate is required.</small></div>
