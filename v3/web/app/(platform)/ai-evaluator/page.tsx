    ...
    <main className="workspacePage">
      ...
      {runMethod === "local" && <section className="registrySection clientRunnerGuide" id="client-delivery">
        ...
        <div className="clientRunnerSteps">
          ...
          <div><span>02 / CREATE AND RUN</span><strong>Keep inputs in the customer environment</strong><code>esx-eval init --directory .\my-agent-evaluation --agent-id support-agent --subject-version 2.4.0</code><small>Creates 20 balanced local placeholders and a guide. Point the local bridge at the team-owned adapter, then run beside the AI system. Prompts, outputs, source files, tool results, stderr, and private keys remain local.</small></div>
