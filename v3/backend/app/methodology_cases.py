...
CASES = (
    ...
    MethodologyCase("ESX-STANDARDS-001", "attack_surface", "standards_discovery", frozenset({"light", "medium", "aggressive"}), "Published security and API metadata discovery"),
    MethodologyCase("ESX-SURFACE-002", "attack_surface", "application_surface_inventory", frozenset({"light", "medium", "aggressive"}), "Safe application route, form, parameter, and client-resource inventory"),
    ...
    MethodologyCase("ESX-API-002", "api_security", "api_contract_review", frozenset({"light", "medium", "aggressive"}), "Published API contract and authentication-scheme review"),
    MethodologyCase("ESX-CONFIG-002", "service_tls_http_configuration", "route_security_policy_review", frozenset({"light", "aggressive"}), "Route-level HTTP security policy consistency review"),
    ...
    MethodologyCase("ESX-WEB-POSTURE-001", "service_tls_http_configuration", "external_web_posture", frozenset({"light", "medium", "aggressive"}), "Cross-origin and publicly issued cookie posture review"),
